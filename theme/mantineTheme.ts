  ...
  components: {
    ...
    SegmentedControl: SegmentedControl.extend({
      ...
      vars: (theme, props) =>
        ({
          control: {
            "--separator-color": "var(--custom-dimmed-1)",
          },
        } as any), //This is valid, and the type that its forcing me to use (sc-color) is wrong
    }),
    ...
    Divider: Divider.extend({
      styles: (theme) => ({
        root: {
          borderTopColor: "var(--custom-divider",
        },
      }),
    }),
    ...
    Button: Button.extend({
      ...
      vars: (theme, props) => {
        ...
        return {
          loader: {
            "--loader-color": "var(--custom-dimmed-3) !important",
          },
          root: {
            "--button-color": (() => {
    ...
    Pagination: Pagination.extend({
      classNames: {
        control: "mantine-pagination-control",
      },
      styles: (theme) => ({
        control: {
          backgroundColor: "var(--custom-dimmed-0)",
    ...
    Slider: Slider.extend({
      styles: (theme) => ({
        thumb: {
          borderColor: "var(--slider-color) !important",
          backgroundColor: "var(--custom-dimmed-1) !important",
        },
      }),
      classNames: {
        track: "mantine-slider-track",
      },
    }),
